...
#define BRANCO 0  //quarto não explorado
#define PRETO 1   //quarto explorado
#define VERMELHO 2//cheguei na porta, mas não tenho a chave
...
private:
    ...
    list<int> chaves;
    bool open;
    int idQuartoAnterior; //será usada apenas em caso de encontrar quartos fechados
...
public:
    ...
    void abrePortas(queue<Quarto*> &Q, Quarto *q){ //abre as portas com as chaves encontradas no quarto e, caso o quarto já foi encontrado, explora ele
        ...
        for(list<int>::iterator it2=chaves.begin(); it2!=chaves.end();it2++){
            ...
            if(Quartos[*it2].getCor()==VERMELHO){
                ...
                numQuartosRestantes++; //como o quarto será reexplorado, aumenta um nos quartos restantes
